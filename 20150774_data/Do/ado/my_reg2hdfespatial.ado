capture program drop my_reg2hdfespatial 
...
*NB - 15/02/2016 - modification line 199 to call my_ols_spatial_HAC instead of ols_spatial_HAC
* Modification also lines 1 and 32 to rename the ado
 Syntax:
...
program my_reg2hdfespatial, eclass byable(recall)
//version 9.2
version 11
...
*MODIFICATION HERE
my_ols_spatial_HAC `Y' `XX', lat(`lat') lon(`lon') timevar(`timevar') panelvar(`panelvar') lagcutoff(`lagcutoff') distcutoff(`distcutoff') bartlett
